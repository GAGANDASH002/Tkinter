...
def getvals():
    ...
    print(f"{nameval.get() ,phoneval.get() ,ageval.get(),payval.get() ,foodserviceval.get()}")
    
    with open ("record.txt","a") as f:#storing user info in a separate file
        f.write(f"User values:{nameval.get() ,phoneval.get() ,ageval.get(),payval.get() ,foodserviceval.get()}")
